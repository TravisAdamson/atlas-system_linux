...
/**
 * blur_image - blurs an entire image using Gaussian Blur in portions
...
/**
 * split_image_into_portions - breaks image into an array of portions
 ...
 *                         image portions to use for blurring
 * @max_threads: maximum amount of threads allotted
...
/**
 * portion_init - initializes each new portion
 * @portion: pointer to which portion to initialize
...
/**
 * blur_portion_mt - multithreading wrapper for blur_portion
